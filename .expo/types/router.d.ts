...
export namespace ExpoRouter {
  type StaticRoutes = `/_sitemap` | `/login/forget.screen` | `/login/login.screen` | `/login/login.screenstyle` | `/login/register.screen` | `/main/addexpense.screen` | `/main/analytics.screen` | `/main/bets.screen` | `/main/budget.screen` | `/main/editprof.screen` | `/main/expense.screen` | `/main/friends.screen` | `/main/groupdetails.screen` | `/main/homepage.screen` | `/main/settings.screen` | `/main/settings.screenstyle` | `/main/winnerlog.screen`;
